...
### After seeing the variable Jobs within 45 minutes (D5AR) that have highest correlation with regional centrality (D5CRI), we decided to draw map plot to see how did these two variables acted in spatial map plot.

### 3. Map plot

#### (1) Map plot for Regional Centrality Index (D5CRI)
...
#### (2) Map plot for Jobs within 45 minutes (D5AR)
